...
In order to follow along with this lesson, you need to have a simple Next.js app. If you have followed the tutorial up to this point you already have what you need, otherwise, download the following example app:
